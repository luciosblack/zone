...
<nav class="navbar navbar-expand-lg navbar-absolute fixed-top back-branco hide" id="top-bar" color-on-scroll="500">
	...
	<a href="http://www.mesquita.rj.gov.br/pmm/" target="_blank" class="retira_padding_verticais btn btn-link">
		<img class="logo" src="{{ asset("img/Logotipo-Horizontal-Colorido-PMM.png") }}">
 	</a>
  
  <div class="col-sm flex-item" style="
    padding-bottom: 0px;
    padding-top: 0px;">
  ...
  <a class="btn btn-link flex-item retira_padding_verticais">
		<img class="logo360 retira_padding_verticais" src="{{ asset("img/loading.gif") }}">
	</a>
